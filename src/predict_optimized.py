...
print("="*70)
print(" MALLORN TDE Classification - Optimized Prediction Pipeline")
print("="*70)
...
features_path = processed_dir / 'test_features_v2.csv'
...
print(f"  Mean probability for predicted class: {np.mean(y_proba):.3f}")
...
detailed_path = f'predictions_optimized_with_probabilities.csv'
...
submission_path = f'submission_optimized_{timestamp}.csv'
